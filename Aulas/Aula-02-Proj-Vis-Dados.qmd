...
## O que é um Projeto de Visualização de Dados Epidemiológico {background-image=/template-ppt/img1_adj_reveal.png}
...
## Exemplos: IDS {background-image=/template-ppt/img1_adj_reveal.png}

![](../imagens/ids-covid.png)

## Exemplos: AppCoorte100M {background-image=/template-ppt/img1_adj_reveal.png}

![](../imagens/appcoorte-hd.png)

## Introdução do Projeto {background-image=/template-ppt/img1_adj_reveal.png}
...
## Objetivo do Projeto {background-image=/template-ppt/img1_adj_reveal.png}
...
## Metodologia {background-image=/template-ppt/img1_adj_reveal.png}
...
## Desenvolvimento {background-image=/template-ppt/img1_adj_reveal.png}
...
## Apresentação e Conclusão {background-image=/template-ppt/img1_adj_reveal.png}
...
## Como elaborar uma visualização {background-image=/template-ppt/img1_adj_reveal.png}
...
## Entendendo o contexto {background-image=/template-ppt/img1_adj_reveal.png}
...
## Escolher a visualização mais efetiva {background-image=/template-ppt/img1_adj_reveal.png}
...
## Gráfico de pontos  {background-image=/template-ppt/img1_adj_reveal.png}

![](../imagens/graph-points.png)

## Gráfico de linhas {background-image=/template-ppt/img1_adj_reveal.png}

![](../imagens/graph-line-compare.png)


## Gráfico de área {background-image=/template-ppt/img1_adj_reveal.png}

![](../imagens/graph-area-compare.png)

## Elimininando distrações {background-image=/template-ppt/img1_adj_reveal.png}
...
## Eliminando distrações e refazendo um gráfico {background-image=/template-ppt/img1_adj_reveal.png}
...
## Atributos pré-atencionais {background-image=/template-ppt/img1_adj_reveal.png}

![](../imagens/preemptive-atributes.png)

## Pense como um designer {background-image=/template-ppt/img1_adj_reveal.png}
...
## Conte uma história {background-image=/template-ppt/img1_adj_reveal.png}
...
## Fontes/Bibliografia {background-image=/template-ppt/img1_adj_reveal.png}
