...
## Contextualização do mercado atual {background-image=/template-ppt/img1_adj_reveal.png}
...
## O que é visualização de dados? {background-image=/template-ppt/img1_adj_reveal.png}
...
## Definições {background-image=/template-ppt/img1_adj_reveal.png}
...
## Um exemplo prático {background-image=/template-ppt/img1_adj_reveal.png}
...
## Mitos de visualização de dados {background-image=/template-ppt/img1_adj_reveal.png}
...
## Alguns norteadores para visualizações {background-image=/template-ppt/img1_adj_reveal.png}
...
## Bibliografia {background-image=/template-ppt/img1_adj_reveal.png}

<p class="bibliografia">Knaflic, C. N. **Storytelling com dados: um guia sobre visualização de dados para profissionais de negócios**. 2ª edição. Rio de Janeiro: Alta Books, 2019.</p>

<p class="bibliografia">Kirk, A. **Data Visualization: A Successful Design Process**. Birmingham: Packt Publishing, 2012.</p>

<p class="bibliografia">FRIENDLY, M. .**Milestones in the history of thematic cartography, statistical graphics, and data visualization**.Utah State University. 2008. Disponível em: <https://www.usu.edu/math/symanzik/teaching/2009_stat6560/Downloads/Friendly_milestone.pdf>. Acesso em: 09/03/23.</p>

<p class="bibliografia">Few, Stephen. "Data visualization for human perception." The Encyclopedia of Human-Computer Interaction, 2nd Ed. (2013).</p>
